...
<ul>
<li>But what does it mean in practice?</li>
<li>How can a biologist incorporapte those principles in their workflow?</li>
<li>We will learn that becoming FAIR and following OS practices is a process.</li>
</ul>
Nowadays you can be FAIR ready rather than FAIR from the beggining. Through planning and using the correct set of tools you can easily make your outputs public and reusable.
</p>
...
Software Carpentry, Data Carpentry, and Library Carpentry's mission is to help scientists, researchers, and librarians get more research done in less time and with less pain by teaching them basic lab skills for scientific computing. This hands-on two-day workshop covers the basics of XXXX, and looks at how to use these ideas in your own projects. 
